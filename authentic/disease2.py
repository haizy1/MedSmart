...
file_path = os.path.join(current_dir, "Testing.csv")
file_path2 = os.path.join(current_dir, "Training.csv")
...
# Now you can call the function with a list of symptoms
symptoms = ['chills', 'fatigue', 'cough','itching','blood_in_sputum']
predicted_disease1 = NaiveBayes(symptoms)
print("Predicted Disease:", predicted_disease1)
